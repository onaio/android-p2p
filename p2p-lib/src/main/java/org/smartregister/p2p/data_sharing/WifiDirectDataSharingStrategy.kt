...
class WifiDirectDataSharingStrategy() : DataSharingStrategy, P2PManagerListener {
    ...
    override fun connect(device: DeviceInfo, operationListener: DataSharingStrategy.OperationListener) {
    ...
    override fun disconnect(device: DeviceInfo, operationListener: DataSharingStrategy.OperationListener) {
    ...
    override fun send(device: DeviceInfo, syncPayload: SyncPayload, operationListener: DataSharingStrategy.OperationListener) {
...
*/
    override fun sendManifest(device: DeviceInfo, manifest: Manifest, operationListener: DataSharingStrategy.OperationListener) {
        // Check if the socket is setup for sending
        // Check if this is the sender/receiver
    }

    override fun receive(device: DeviceInfo, syncPayload: SyncPayload, operationListener: DataSharingStrategy.OperationListener) {
        // Check if the socket is setup for listening
        // Check if this is the receiver/sender
    }

    override fun receiveManifest(device: DeviceInfo, manifest: Manifest, operationListener: DataSharingStrategy.OperationListener) {
        // Check if the socket is setup for listening
        // Check if this is the receiver/sender
    }
