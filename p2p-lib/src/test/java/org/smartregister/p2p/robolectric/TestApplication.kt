...
/**
 * This class is used to set the theme in order to fix the following exception when running activity
 * tests java.lang.IllegalStateException: You need to use a Theme.AppCompat theme (or descendant)
 * with this activity.
 */
